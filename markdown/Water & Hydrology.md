...
Various coordinated research-and-development datasets of England's land, freshwater, and coastal ecosystems. Aiming to produce a baseline of natural assets by 2028 following an ongoing five-year survey. Data first became available in 2025. Parnered with several envioronmental agencies and organisations. Combines remote and ground surveying. Surveyors are sampling 2500 1km^2 grid squares across, recording information on plants, habitats, hedgerows, streams and rivers, trees outside of woodlands, ponds, landscape, and soils.
...
Hydrology readings from nearly 8000 river monitoring stations across England. Includes daily and subdaily recordings for various related metrics including flow, level, rainfall, groundwater level, pH, chlorophyll level, trubidity, ammonium, algae etc. Different stations monitor different metrics, and historic data varies by station. Less current the Real-Time Flood Monitoring API, but includes more measures.
...
Rainfall, in mm, as recorded across over 1000m measuring stations across England. Data is captured every 15 minutes, with bi-daily uploads. Historic data can be accessed up to 12 months, and earlier by email request (incomplete prior to 2016).
...
## EA Ecology & Fish Data API

National Fish Population Database (freshwater and coastal), and Biosys (microinvertebrate, macrophyte, diatom, benthic invertebrate, phytoplankton) observations. Includes fish counts, species estimates, length and weight estimates etc.
...
Detailed water feature and network data. The feature data includes water bodies and watercourses, their names, tidal data and boundaries, water catchments, and classifications and descriptions. The network layers include connectivity, flow direction, and width information.

- **Category:** Water & Hydrology
- **Secondary Category:** 
- **Provider:** Ordnance Survey
- **Licensing:** Premium
- **Data link 1:** [Data link 1](https://www.ordnancesurvey.co.uk/products/os-water-features)
...
- **Docs link:** [Docs link](https://docs.os.uk/osngd/data-structure/water)



## Overture Maps Base Layer
