...
| [OS NGD Administrative & Statistical Units Theme](#os-ngd-administrative-&-statistical-units-theme) | Ordnance Survey                | Premium   | [Data link 1](https://www.ordnancesurvey.co.uk/products/os-ngd-api-features#get)                                                            |                                                                                                                                   | [Docs link](https://docs.os.uk/osngd/data-structure/administrative-and-statistical-units)                                                                 |
...
## OS NGD Administrative & Statistical Units Theme
...
Built up areas of Great Britain reflecting the built environment in the real world rather than official or statistical units. Built up areas include names, and are split into two subsidary ayers: built-up extents, and non-built-up extents.
